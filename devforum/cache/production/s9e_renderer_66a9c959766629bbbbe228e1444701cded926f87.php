...
*/
class s9e_renderer_66a9c959766629bbbbe228e1444701cded926f87 extends \s9e\TextFormatter\Renderer
{
	...
	private static $quickBranches=array('/B'=>0,'/I'=>1,'ATTACHMENT'=>2,'B'=>3,'CODE'=>4,'E'=>5,'EMAIL'=>6,'EMOJI'=>7,'I'=>8,'LINK_TEXT'=>9,'QUOTE'=>10);
	public $quickRenderingTest='(<(?=[FIL])(?>FLASH|IMG|LIST)[ />])';
	...
	protected function quick($m)
	{
		...
		{
			if ($id[0] === '!' || $id[0] === '?' || preg_match('(^/?(?>FLASH|IMG|LIST)$)', $id))
				throw new \RuntimeException;
			return '';
		}
