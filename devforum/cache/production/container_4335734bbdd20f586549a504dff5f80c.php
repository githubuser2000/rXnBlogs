...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006aa7b98f00000000736192b2(
...
class phpbbtemplatetwiglexer_000000006aa7b98f00000000736192b2 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ae807973107f397544062 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ae8079731086324716416 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ae807973106b801159168 = array(
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, 'set_environment', array('env' => $env), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;

        return $this->valueHolder5ae807973107f397544062->set_environment($env);
    }
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;

        return $this->valueHolder5ae807973107f397544062->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;

        return $this->valueHolder5ae807973107f397544062->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ae8079731086324716416 = $initializer;
    }
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, '__get', array('name' => $name), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;

        if (isset(self::$publicProperties5ae807973106b801159168[$name])) {
            return $this->valueHolder5ae807973107f397544062->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ae807973107f397544062;
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, '__isset', array('name' => $name), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, '__unset', array('name' => $name), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;
    ...
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, '__clone', array(), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;

        $this->valueHolder5ae807973107f397544062 = clone $this->valueHolder5ae807973107f397544062;
    }

    public function __sleep()
    {
        $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, '__sleep', array(), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;

        return array('valueHolder5ae807973107f397544062');
    }
    ...
    {
        return $this->initializer5ae8079731086324716416;
    }
    ...
    {
        return $this->initializer5ae8079731086324716416 && ($this->initializer5ae8079731086324716416->__invoke($valueHolder5ae807973107f397544062, $this, 'initializeProxy', array(), $this->initializer5ae8079731086324716416) || 1) && $this->valueHolder5ae807973107f397544062 = $valueHolder5ae807973107f397544062;
    }
    ...
    {
        return null !== $this->valueHolder5ae807973107f397544062;
    }
    ...
    {
        return $this->valueHolder5ae807973107f397544062;
    }
