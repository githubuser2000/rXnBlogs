...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbb_01config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../', 'php', 'phpbb_01forums', 'phpbb_01posts', 'phpbb_01topics', 'phpbb_01users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbb_01captcha_questions', 'phpbb_01captcha_answers', 'phpbb_01qa_confirm');
    ...
    protected function getDispatcherService()
    {
        ...
        }, 1 => 'on_kernel_terminate'], -2147483647-1);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbb_01ext', './../', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'phpbb_01notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../', 'php', 'phpbb_01user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01bbcodes', 'phpbb_01smilies', 'phpbb_01styles', 'phpbb_01words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_01users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'phpbb_01users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'phpbb_01acl_groups',
            'tables.acl_options' => 'phpbb_01acl_options',
            'tables.acl_roles' => 'phpbb_01acl_roles',
            'tables.acl_roles_data' => 'phpbb_01acl_roles_data',
            'tables.acl_users' => 'phpbb_01acl_users',
            'tables.attachments' => 'phpbb_01attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbb_01oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbb_01oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbb_01oauth_accounts',
            'tables.banlist' => 'phpbb_01banlist',
            'tables.bbcodes' => 'phpbb_01bbcodes',
            'tables.bookmarks' => 'phpbb_01bookmarks',
            'tables.bots' => 'phpbb_01bots',
            'tables.captcha_qa_questions' => 'phpbb_01captcha_questions',
            'tables.captcha_qa_answers' => 'phpbb_01captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbb_01qa_confirm',
            'tables.config' => 'phpbb_01config',
            'tables.config_text' => 'phpbb_01config_text',
            'tables.confirm' => 'phpbb_01confirm',
            'tables.disallow' => 'phpbb_01disallow',
            'tables.drafts' => 'phpbb_01drafts',
            'tables.ext' => 'phpbb_01ext',
            'tables.extensions' => 'phpbb_01extensions',
            'tables.extension_groups' => 'phpbb_01extension_groups',
            'tables.forums' => 'phpbb_01forums',
            'tables.forums_access' => 'phpbb_01forums_access',
            'tables.forums_track' => 'phpbb_01forums_track',
            'tables.forums_watch' => 'phpbb_01forums_watch',
            'tables.groups' => 'phpbb_01groups',
            'tables.icons' => 'phpbb_01icons',
            'tables.lang' => 'phpbb_01lang',
            'tables.log' => 'phpbb_01log',
            'tables.login_attempts' => 'phpbb_01login_attempts',
            'tables.migrations' => 'phpbb_01migrations',
            'tables.moderator_cache' => 'phpbb_01moderator_cache',
            'tables.modules' => 'phpbb_01modules',
            'tables.notification_emails' => 'phpbb_01notification_emails',
            'tables.notification_types' => 'phpbb_01notification_types',
            'tables.notifications' => 'phpbb_01notifications',
            'tables.poll_options' => 'phpbb_01poll_options',
            'tables.poll_votes' => 'phpbb_01poll_votes',
            'tables.posts' => 'phpbb_01posts',
            'tables.privmsgs' => 'phpbb_01privmsgs',
            'tables.privmsgs_folder' => 'phpbb_01privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbb_01privmsgs_rules',
            'tables.privmsgs_to' => 'phpbb_01privmsgs_to',
            'tables.profile_fields' => 'phpbb_01profile_fields',
            'tables.profile_fields_data' => 'phpbb_01profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbb_01profile_fields_lang',
            'tables.profile_fields_language' => 'phpbb_01profile_lang',
            'tables.ranks' => 'phpbb_01ranks',
            'tables.reports' => 'phpbb_01reports',
            'tables.reports_reasons' => 'phpbb_01reports_reasons',
            'tables.search_results' => 'phpbb_01search_results',
            'tables.search_wordlist' => 'phpbb_01search_wordlist',
            'tables.search_wordmatch' => 'phpbb_01search_wordmatch',
            'tables.sessions' => 'phpbb_01sessions',
            'tables.sessions_keys' => 'phpbb_01sessions_keys',
            'tables.sitelist' => 'phpbb_01sitelist',
            'tables.smilies' => 'phpbb_01smilies',
            'tables.sphinx' => 'phpbb_01sphinx',
            'tables.styles' => 'phpbb_01styles',
            'tables.styles_template' => 'phpbb_01styles_template',
            'tables.styles_template_data' => 'phpbb_01styles_template_data',
            'tables.styles_theme' => 'phpbb_01styles_theme',
            'tables.styles_imageset' => 'phpbb_01styles_imageset',
            'tables.styles_imageset_data' => 'phpbb_01styles_imageset_data',
            'tables.teampage' => 'phpbb_01teampage',
            'tables.topics' => 'phpbb_01topics',
            'tables.topics_posted' => 'phpbb_01topics_posted',
            'tables.topics_track' => 'phpbb_01topics_track',
            'tables.topics_watch' => 'phpbb_01topics_watch',
            'tables.user_group' => 'phpbb_01user_group',
            'tables.user_notifications' => 'phpbb_01user_notifications',
            'tables.users' => 'phpbb_01users',
            'tables.warnings' => 'phpbb_01warnings',
            'tables.words' => 'phpbb_01words',
            'tables.zebra' => 'phpbb_01zebra',
            ...
            'tables' => [
                'acl_groups' => 'phpbb_01acl_groups',
                'acl_options' => 'phpbb_01acl_options',
                'acl_roles' => 'phpbb_01acl_roles',
                'acl_roles_data' => 'phpbb_01acl_roles_data',
                'acl_users' => 'phpbb_01acl_users',
                'attachments' => 'phpbb_01attachments',
                'auth_provider_oauth_token_storage' => 'phpbb_01oauth_tokens',
                'auth_provider_oauth_states' => 'phpbb_01oauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbb_01oauth_accounts',
                'banlist' => 'phpbb_01banlist',
                'bbcodes' => 'phpbb_01bbcodes',
                'bookmarks' => 'phpbb_01bookmarks',
                'bots' => 'phpbb_01bots',
                'captcha_qa_questions' => 'phpbb_01captcha_questions',
                'captcha_qa_answers' => 'phpbb_01captcha_answers',
                'captcha_qa_confirm' => 'phpbb_01qa_confirm',
                'config' => 'phpbb_01config',
                'config_text' => 'phpbb_01config_text',
                'confirm' => 'phpbb_01confirm',
                'disallow' => 'phpbb_01disallow',
                'drafts' => 'phpbb_01drafts',
                'ext' => 'phpbb_01ext',
                'extensions' => 'phpbb_01extensions',
                'extension_groups' => 'phpbb_01extension_groups',
                'forums' => 'phpbb_01forums',
                'forums_access' => 'phpbb_01forums_access',
                'forums_track' => 'phpbb_01forums_track',
                'forums_watch' => 'phpbb_01forums_watch',
                'groups' => 'phpbb_01groups',
                'icons' => 'phpbb_01icons',
                'lang' => 'phpbb_01lang',
                'log' => 'phpbb_01log',
                'login_attempts' => 'phpbb_01login_attempts',
                'migrations' => 'phpbb_01migrations',
                'moderator_cache' => 'phpbb_01moderator_cache',
                'modules' => 'phpbb_01modules',
                'notification_emails' => 'phpbb_01notification_emails',
                'notification_types' => 'phpbb_01notification_types',
                'notifications' => 'phpbb_01notifications',
                'poll_options' => 'phpbb_01poll_options',
                'poll_votes' => 'phpbb_01poll_votes',
                'posts' => 'phpbb_01posts',
                'privmsgs' => 'phpbb_01privmsgs',
                'privmsgs_folder' => 'phpbb_01privmsgs_folder',
                'privmsgs_rules' => 'phpbb_01privmsgs_rules',
                'privmsgs_to' => 'phpbb_01privmsgs_to',
                'profile_fields' => 'phpbb_01profile_fields',
                'profile_fields_data' => 'phpbb_01profile_fields_data',
                'profile_fields_options_language' => 'phpbb_01profile_fields_lang',
                'profile_fields_language' => 'phpbb_01profile_lang',
                'ranks' => 'phpbb_01ranks',
                'reports' => 'phpbb_01reports',
                'reports_reasons' => 'phpbb_01reports_reasons',
                'search_results' => 'phpbb_01search_results',
                'search_wordlist' => 'phpbb_01search_wordlist',
                'search_wordmatch' => 'phpbb_01search_wordmatch',
                'sessions' => 'phpbb_01sessions',
                'sessions_keys' => 'phpbb_01sessions_keys',
                'sitelist' => 'phpbb_01sitelist',
                'smilies' => 'phpbb_01smilies',
                'sphinx' => 'phpbb_01sphinx',
                'styles' => 'phpbb_01styles',
                'styles_template' => 'phpbb_01styles_template',
                'styles_template_data' => 'phpbb_01styles_template_data',
                'styles_theme' => 'phpbb_01styles_theme',
                'styles_imageset' => 'phpbb_01styles_imageset',
                'styles_imageset_data' => 'phpbb_01styles_imageset_data',
                'teampage' => 'phpbb_01teampage',
                'topics' => 'phpbb_01topics',
                'topics_posted' => 'phpbb_01topics_posted',
                'topics_track' => 'phpbb_01topics_track',
                'topics_watch' => 'phpbb_01topics_watch',
                'user_group' => 'phpbb_01user_group',
                'user_notifications' => 'phpbb_01user_notifications',
                'users' => 'phpbb_01users',
                'warnings' => 'phpbb_01warnings',
                'words' => 'phpbb_01words',
                'zebra' => 'phpbb_01zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbb_01',
