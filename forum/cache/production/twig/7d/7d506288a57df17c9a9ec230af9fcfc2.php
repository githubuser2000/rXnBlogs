...
class __TwigTemplate_512690c1972541314982269137c7ee7d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
                ...
                // line 22
                echo "\t<div class=\"post ";
                if ((twig_get_attribute($this->env, $this->source, $context["topic_review_row"], "S_ROW_COUNT", [], "any", false, false, false, 22) % 2 != 0)) {
                    echo "bg1";
                } else {
                    echo "bg2";
                }
