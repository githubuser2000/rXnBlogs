...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'vse.abbc3.bbcodes_parser' => 'getVse_Abbc3_BbcodesParserService',
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000175dfc8f000000003454de75(
    ...
    /**
     * Gets the public 'vse.abbc3.acp_listener' shared service.
     *
     * @return \vse\abbc3\event\acp_listener
     */
    protected function getVse_Abbc3_AcpListenerService()
    {
        return $this->services['vse.abbc3.acp_listener'] = new \vse\abbc3\event\acp_listener($this->get('vse.abbc3.acp_manager'), './../');
    }

    /**
     * Gets the public 'vse.abbc3.acp_manager' shared service.
     *
     * @return \vse\abbc3\core\acp_manager
     */
    protected function getVse_Abbc3_AcpManagerService()
    {
        return $this->services['vse.abbc3.acp_manager'] = new \vse\abbc3\core\acp_manager($this->get('dbal.conn'), $this->get('request'), $this->get('user'));
    }

    /**
     * Gets the public 'vse.abbc3.bbcodes_display' shared service.
     *
     * @return \vse\abbc3\core\bbcodes_display
     */
    protected function getVse_Abbc3_BbcodesDisplayService()
    {
        return $this->services['vse.abbc3.bbcodes_display'] = new \vse\abbc3\core\bbcodes_display($this->get('dbal.conn'), $this->get('ext.manager'), $this->get('user'), './../ext/vse/abbc3/');
    }

    /**
     * Gets the public 'vse.abbc3.bbcodes_parser' shared service.
     *
     * @return \vse\abbc3\core\bbcodes_parser
     */
    protected function getVse_Abbc3_BbcodesParserService()
    {
        return $this->services['vse.abbc3.bbcodes_parser'] = new \vse\abbc3\core\bbcodes_parser($this->get('user'));
    }

    /**
     * Gets the public 'vse.abbc3.listener' shared service.
     *
     * @return \vse\abbc3\event\listener
     */
    protected function getVse_Abbc3_ListenerService()
    {
        return $this->services['vse.abbc3.listener'] = new \vse\abbc3\event\listener($this->get('vse.abbc3.bbcodes_parser'), $this->get('vse.abbc3.bbcodes_display'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), 'ext/vse/abbc3/');
    }

    /**
     * Gets the public 'vse.abbc3.wizard' shared service.
     *
     * @return \vse\abbc3\controller\wizard
     */
    protected function getVse_Abbc3_WizardService()
    {
        return $this->services['vse.abbc3.wizard'] = new \vse\abbc3\controller\wizard($this->get('controller.helper'), $this->get('request'), $this->get('template'), $this->get('user'), './../ext/vse/abbc3/');
    }
...
class phpbbtemplatetwiglexer_00000000175dfc8f000000003454de75 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ae8078fbc6a4868020607 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ae8078fbc6ad893922558 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ae8078fbc687200182606 = array(
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, 'set_environment', array('env' => $env), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;

        return $this->valueHolder5ae8078fbc6a4868020607->set_environment($env);
    }
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;

        return $this->valueHolder5ae8078fbc6a4868020607->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;

        return $this->valueHolder5ae8078fbc6a4868020607->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 = $initializer;
    }
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, '__get', array('name' => $name), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;

        if (isset(self::$publicProperties5ae8078fbc687200182606[$name])) {
            return $this->valueHolder5ae8078fbc6a4868020607->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ae8078fbc6a4868020607;
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, '__isset', array('name' => $name), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, '__unset', array('name' => $name), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;
    ...
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, '__clone', array(), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;

        $this->valueHolder5ae8078fbc6a4868020607 = clone $this->valueHolder5ae8078fbc6a4868020607;
    }

    public function __sleep()
    {
        $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, '__sleep', array(), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;

        return array('valueHolder5ae8078fbc6a4868020607');
    }
    ...
    {
        return $this->initializer5ae8078fbc6ad893922558;
    }
    ...
    {
        return $this->initializer5ae8078fbc6ad893922558 && ($this->initializer5ae8078fbc6ad893922558->__invoke($valueHolder5ae8078fbc6a4868020607, $this, 'initializeProxy', array(), $this->initializer5ae8078fbc6ad893922558) || 1) && $this->valueHolder5ae8078fbc6a4868020607 = $valueHolder5ae8078fbc6a4868020607;
    }
    ...
    {
        return null !== $this->valueHolder5ae8078fbc6a4868020607;
    }
    ...
    {
        return $this->valueHolder5ae8078fbc6a4868020607;
    }
