...
class __TwigTemplate_a2be5c41e654954e46c82520ecba5ce47c84e213b44d2fd41ea6d6c52c57966e extends Twig_Template
{
...
\t<a href=\"#acl\">&raquo; ";
            // line 32
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("SET_ROLE_PERMISSIONS");
            echo "</a>
...
\t\t<legend>";
            // line 37
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("ROLE_DETAILS");
            echo "</legend>
\t<dl>
\t\t<dt><label for=\"role_name\">";
            // line 39
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("ROLE_NAME");
...
\t\t<dt><label for=\"role_description\">";
            ...
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("COLON");
            echo "</label><br /><span>";
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("ROLE_DESCRIPTION_EXPLAIN");
            echo "</span></dt>
...
\t\t<h1>";
                // line 55
                echo $this->env->getExtension('phpbb\template\twig\extension')->lang("ROLE_ASSIGNED_TO");
                echo "</h1>
...
\t<h1>";
            // line 70
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("ACL_TYPE");
            echo "</h1>
...
\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "auth", array()));
...
\t";
            // line 154
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "roles", array()));
...
\t\t<td style=\"width: 30%; text-align: center; vertical-align: top; white-space: nowrap;\">";
                ...
                if ($this->getAttribute($context["roles"], "U_DISPLAY_ITEMS", array())) {
                    ...
                    echo "\">";
                    echo $this->env->getExtension('phpbb\template\twig\extension')->lang("VIEW_ASSIGNED_ITEMS");
                    echo "</a>";
                } else {
                    echo $this->env->getExtension('phpbb\template\twig\extension')->lang("VIEW_ASSIGNED_ITEMS");
                }
...
\t\t\t<a href=\"";
                ...
                echo "\" title=\"";
                echo $this->env->getExtension('phpbb\template\twig\extension')->lang("EDIT_ROLE");
                echo "\">";
...
\t\t\t<a href=\"";
                ...
                echo "\" title=\"";
                echo $this->env->getExtension('phpbb\template\twig\extension')->lang("REMOVE_ROLE");
...
\t\t";
            // line 174
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("CREATE_ROLE");
            echo $this->env->getExtension('phpbb\template\twig\extension')->lang("COLON");
            ...
            if (($context["S_ROLE_OPTIONS"] ?? null)) {
                ...
                echo $this->env->getExtension('phpbb\template\twig\extension')->lang("CREATE_ROLE_FROM");
                echo "</option>";
...
";
    ...
    {
        return new Twig_Source("", "acp_permission_roles.html", "");
    }
}
